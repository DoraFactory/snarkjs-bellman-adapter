...
const adaptToUncompressed = async (verificationKeyName, proofName) => {
    ...
    fs.writeFileSync(path.resolve(`../../circuit/qf-maci/build/final_proof/${circuit_name}/proof_hex.json`), JSON.stringify(hex_proof));
    fs.writeFileSync(path.resolve(`../../circuit/qf-maci/build/final_verification_key/${circuit_name}/vkey_hex.json`), JSON.stringify(hex_vkey));
...
adaptToUncompressed(`../../circuit/qf-maci/build/verification_key/${circuit_name}/verification_key.json`, `../../circuit/qf-maci/build/proof/${circuit_name}/proof.json`)
